...
//时钟
unsigned char szds1302[]={22,33,44}; //初始时间为22.33.44
unsigned char shijian[6]={0,0,0,0,0,0};//存储时间数组
...
Timer1Init();//定时器一初始化
wwrite_ds1302(szds1302);//设定初始时间
while(1)
{
	smg[0]=shijian[0];//小时十位
  smg[1]=shijian[1];//小时个位
	
	smg[2]=17;
	
	smg[3]=shijian[2];//分钟十位
  smg[4]=shijian[3];//分钟个位	
